...
alias cactive='cat /sys/kernel/cluster/active'
...
alias miscinstall='apt-get update && apt-get install man cifs-utils evtest mlocate usbutils scrot vim libav-tools file -y && updatedb' #gdisk dosfstools
